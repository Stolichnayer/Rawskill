...
/* =============================================== FIX ===============================================================*/
            //if (!m_Jump) ---> fixed automatically jumping second time!
...
/* =============================================== FIX? ==============================================================*/
            // CHANGING THIS TO ELIMINATE The 'sticky' button release
            desiredMove = Vector3.ProjectOnPlane(desiredMove, hitInfo.normal).normalized;

            // Possible fix but fixed it with input gravity from 3 --> 7 (horizontal and vertical)
            /*desiredMove = Vector3.ProjectOnPlane(desiredMove, hitInfo.normal);
            desiredMove = Vector3.ClampMagnitude(desiredMove, 1);*/
/* ===================================================================================================================*/

/* ====================================== FIX (Only added following lines) ===========================================*/
            // On air limit control 
            ...
            {
                desiredMove = mLastDesiredMove + desiredMove * 0.3f;
                speed       = mLastSpeed;
            }
/* ===================================================================================================================*/
...
/* =============================================== FIX ===============================================================*/
            // INITIAL: m_Input = new Vector2(horizontal, vertical);
            
            // This stops input completely while jumping
            if (!m_Jumping)
            {
